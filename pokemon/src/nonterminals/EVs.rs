#[path = "EVs/EVs_0_0.rs"]
pub(crate) mod EVs_0_0;
#[path = "EVs/EVs_0_1.rs"]
pub(crate) mod EVs_0_1;
#[path = "EVs/EVs_0_2.rs"]
pub(crate) mod EVs_0_2;
#[path = "EVs/EVs_0_3.rs"]
pub(crate) mod EVs_0_3;
#[allow(non_camel_case_types)]
#[derive(Debug)]
pub(crate) struct EVs;
impl<'a> wagon_gll::Label<'a> for EVs {
    ...
    > {
        Ok(
            vec![
                (vec![state.get_label_by_uuid("EVs_0_0") ?, state
                .get_label_by_uuid("EVs_0_1") ?, state.get_label_by_uuid("EVs_0_2") ?,
                state.get_label_by_uuid("EVs_0_3") ?], None),
            ],
        )
    }
    fn is_eps(&self) -> bool {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let fst = state.get_label_by_uuid("EVs_0_0")?;
        if state.test_next(&fst)? {
            let root = state.get_label_by_uuid("EVs")?;
            let rules = state.get_rule("EVs_0")?;
            let slot = wagon_gll::GrammarSlot::new(root, rules, 0, 0, "EVs_0_0");
