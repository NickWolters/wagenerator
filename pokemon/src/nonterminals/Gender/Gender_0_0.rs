...
#[derive(Debug)]
pub(crate) struct Gender_0_0;
impl<'a> wagon_gll::Label<'a> for Gender_0_0 {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let s_gender: wagon_gll::value::Value = (wagon_value::Value::from("M")).into();
