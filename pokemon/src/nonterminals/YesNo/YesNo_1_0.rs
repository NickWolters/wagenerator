...
#[derive(Debug)]
pub(crate) struct YesNo_1_0;
impl<'a> wagon_gll::Label<'a> for YesNo_1_0 {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let s_yes: wagon_gll::value::Value = (wagon_value::Value::from(false)).into();
