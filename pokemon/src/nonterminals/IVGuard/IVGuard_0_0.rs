...
#[derive(Debug)]
pub(crate) struct IVGuard_0_0;
impl<'a> wagon_gll::Label<'a> for IVGuard_0_0 {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let slot = wagon_gll::GrammarSlot::new(
            state.get_label_by_uuid("IVGuard")?,
            state.get_rule("IVGuard_0")?,
            1,
            0,
            "IVGuard_0",
        );
            ...
            Ok(
                wagon_gll::value::Value::from(
                    wagon_value::Valueable::is_truthy(
                        ...
                        && wagon_value::Valueable::is_truthy(
                            &wagon_value::Value::from(
                                (i_total.clone() <= wagon_value::Value::from(31i32)),
                            ),
                        )?,
                ),
            )
