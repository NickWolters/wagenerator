#[path = "Level/Level_0_0.rs"]
pub(crate) mod Level_0_0;
#[path = "Level/Level_0_1.rs"]
pub(crate) mod Level_0_1;
#[path = "Level/Level_0_2.rs"]
pub(crate) mod Level_0_2;
#[allow(non_camel_case_types)]
#[derive(Debug)]
pub(crate) struct Level;
impl<'a> wagon_gll::Label<'a> for Level {
    ...
    > {
        Ok(
            vec![
                (vec![state.get_label_by_uuid("Level_0_0") ?, state
                .get_label_by_uuid("Level_0_1") ?, state.get_label_by_uuid("Level_0_2")
                ?], None),
            ],
        )
    }
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let fst = state.get_label_by_uuid("Level_0_0")?;
        if state.test_next(&fst)? {
            let root = state.get_label_by_uuid("Level")?;
            let rules = state.get_rule("Level_0")?;
            let slot = wagon_gll::GrammarSlot::new(root, rules, 0, 0, "Level_0_0");
