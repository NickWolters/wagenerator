#[path = "Happiness/Happiness_0_0.rs"]
pub(crate) mod Happiness_0_0;
#[path = "Happiness/Happiness_0_1.rs"]
pub(crate) mod Happiness_0_1;
#[path = "Happiness/Happiness_0_2.rs"]
pub(crate) mod Happiness_0_2;
#[allow(non_camel_case_types)]
#[derive(Debug)]
pub(crate) struct Happiness;
impl<'a> wagon_gll::Label<'a> for Happiness {
    ...
    > {
        Ok(
            vec![
                (vec![state.get_label_by_uuid("Happiness_0_0") ?, state
                .get_label_by_uuid("Happiness_0_1") ?, state
                .get_label_by_uuid("Happiness_0_2") ?], None),
            ],
        )
    }
    fn is_eps(&self) -> bool {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let fst = state.get_label_by_uuid("Happiness_0_0")?;
        if state.test_next(&fst)? {
            let root = state.get_label_by_uuid("Happiness")?;
            let rules = state.get_rule("Happiness_0")?;
            let slot = wagon_gll::GrammarSlot::new(root, rules, 0, 0, "Happiness_0_0");
