#[path = "Pokemon/Pokemon_0_0.rs"]
pub(crate) mod Pokemon_0_0;
#[path = "Pokemon/Pokemon_0_1.rs"]
pub(crate) mod Pokemon_0_1;
#[path = "Pokemon/Pokemon_0_2.rs"]
pub(crate) mod Pokemon_0_2;
#[path = "Pokemon/Pokemon_0_3.rs"]
pub(crate) mod Pokemon_0_3;
#[allow(non_camel_case_types)]
#[derive(Debug)]
pub(crate) struct Pokemon;
impl<'a> wagon_gll::Label<'a> for Pokemon {
    ...
    > {
        Ok(
            vec![
                (vec![state.get_label_by_uuid("Pokemon_0_0") ?, state
                .get_label_by_uuid("Pokemon_0_1") ?, state
                .get_label_by_uuid("Pokemon_0_2") ?, state
                .get_label_by_uuid("Pokemon_0_3") ?], None),
            ],
        )
    }
    fn is_eps(&self) -> bool {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let fst = state.get_label_by_uuid("Pokemon_0_0")?;
        if state.test_next(&fst)? {
            let root = state.get_label_by_uuid("Pokemon")?;
            let rules = state.get_rule("Pokemon_0")?;
            let slot = wagon_gll::GrammarSlot::new(root, rules, 0, 0, "Pokemon_0_0");
