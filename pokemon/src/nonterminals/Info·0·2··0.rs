#[path = "Info·0·2··0/Info·0·2··0_0_0.rs"]
pub(crate) mod Info·0·2··0_0_0;
#[path = "Info·0·2··0/Info·0·2··0_0_1.rs"]
pub(crate) mod Info·0·2··0_0_1;
#[allow(non_camel_case_types)]
#[derive(Debug)]
pub(crate) struct Info·0·2··0;
impl<'a> wagon_gll::Label<'a> for Info·0·2··0 {
    ...
    > {
        Ok(
            vec![
                (vec![state.get_label_by_uuid("Info·0·2··0_0_0") ?, state
                .get_label_by_uuid("Info·0·2··0_0_1") ?], None),
            ],
        )
    }
    fn is_eps(&self) -> bool {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let fst = state.get_label_by_uuid("Info·0·2··0_0_0")?;
        if state.test_next(&fst)? {
            let root = state.get_label_by_uuid("Info·0·2··0")?;
            let rules = state.get_rule("Info·0·2··0_0")?;
