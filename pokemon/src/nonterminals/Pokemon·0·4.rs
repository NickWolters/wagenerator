#[path = "Pokemon·0·4/Pokemon·0·4_0_0.rs"]
pub(crate) mod Pokemon·0·4_0_0;
#[path = "Pokemon·0·4/Pokemon·0·4_0_1.rs"]
pub(crate) mod Pokemon·0·4_0_1;
#[path = "Pokemon·0·4/Pokemon·0·4_0_2.rs"]
pub(crate) mod Pokemon·0·4_0_2;
#[allow(non_camel_case_types)]
#[derive(Debug)]
pub(crate) struct Pokemon·0·4;
impl<'a> wagon_gll::Label<'a> for Pokemon·0·4 {
    ...
    > {
        Ok(
            vec![
                (vec![state.get_label_by_uuid("Pokemon·0·4_0_0") ?, state
                .get_label_by_uuid("Pokemon·0·4_0_1") ?, state
                .get_label_by_uuid("Pokemon·0·4_0_2") ?], None),
            ],
        )
    }
    fn is_eps(&self) -> bool {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let fst = state.get_label_by_uuid("Pokemon·0·4_0_0")?;
        if state.test_next(&fst)? {
            let root = state.get_label_by_uuid("Pokemon·0·4")?;
            let rules = state.get_rule("Pokemon·0·4_0")?;
