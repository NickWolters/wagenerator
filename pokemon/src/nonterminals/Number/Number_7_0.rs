...
#[derive(Debug)]
pub(crate) struct Number_7_0;
impl<'a> wagon_gll::Label<'a> for Number_7_0 {
    ...
    fn code(&self, state: &mut wagon_gll::GLLState<'a>) -> wagon_gll::GLLResult<'a, ()> {
        ...
        let s_value: wagon_gll::value::Value = (wagon_value::Value::from(7i32)).into();
